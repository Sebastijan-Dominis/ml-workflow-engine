...
name = "cancellation_global"
version = "v1"

try:
    feature_path = Path("data/features/cancellation/global/v1")
...
try:
    schema = pd.read_csv(Path("data/features/cancellation/global/v1/schema.csv"))
except Exception:
...
feature_path = "data/features/cancellation/global/v1"
features_version = "v1"
target = "is_canceled"
algorithm = "catboost"
