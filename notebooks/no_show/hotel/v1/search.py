...
name = f"no_show_{args.segment}"
version = "v1"

try:
    feature_path = Path(f"data/features/no_show/hotel/{args.segment}_v1")
...
try:
    schema = pd.read_csv(Path(f"data/features/no_show/hotel/{args.segment}_v1/schema.csv"))
except Exception:
...
feature_path = f"data/features/no_show/hotel/{args.segment}_v1"
features_version = "v1"
target = "no_show"
algorithm = "catboost"
