...
def save_segment(segment):
    ...
    VERSION_NAME = "v1"
    TARGET = "no_show"
    SEGMENTATION_TYPE = "hotel_market_segment"
    ...
    USELESS_COLUMNS = ["is_canceled", "reserved_room_type", SEGMENT_COLUMN_1, SEGMENT_COLUMN_2]
    ...
    print(f"{SEGMENT_VALUE_1} - {SEGMENT_VALUE_2} no-show features saved to {feature_path}")
...
def generate_features_for_segments():
    ...
    segments = {
        # Count: 38748
        "segment_1": {
            "model_name": "city_hotel_online_TA",
            "segment_value_1": "City Hotel",
            "segment_value_2": "Online TA"
        },
        # Count: 16747
        "segment_2": {
            "model_name": "city_hotel_offline_TA_TO",
            "segment_value_1": "City Hotel",
            "segment_value_2": "Offline TA/TO"
        },
        # Count: 13975
        "segment_3": {
            "model_name": "city_hotel_groups",
            "segment_value_1": "City Hotel",
            "segment_value_2": "Groups"
        },
        # Count: 6093
        "segment_4": {
            "model_name": "city_hotel_direct",
            "segment_value_1": "City Hotel",
            "segment_value_2": "Direct"
        },
        # Count: 3767
        "segment_5": {
            "model_name": "city_hotel_other",
            "segment_value_1": "City Hotel",
            "segment_value_2": "Other"
        },
        # Count: 17729
        "segment_6": {
            "model_name": "resort_hotel_online_TA",
            "segment_value_1": "Resort Hotel",
            "segment_value_2": "Online TA"
        },
        # Count: 7472
        "segment_7": {
            "model_name": "resort_hotel_offline_TA_TO",
            "segment_value_1": "Resort Hotel",
            "segment_value_2": "Offline TA/TO"
        },
        # Count: 5835
        "segment_8": {
            "model_name": "resort_hotel_groups",
            "segment_value_1": "Resort Hotel",
            "segment_value_2": "Groups"
        },
        # Count: 6513
        "segment_9": {
            "model_name": "resort_hotel_direct",
            "segment_value_1": "Resort Hotel",
            "segment_value_2": "Direct"
        },
        # Count: 2510
        "segment_10": {
            "model_name": "resort_hotel_other",
            "segment_value_1": "Resort Hotel",
            "segment_value_2": "Other"
        },
    }
