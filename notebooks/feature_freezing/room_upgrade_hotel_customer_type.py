...
def save_segment(segment):
    ...
    VERSION_NAME = "v1"
    TARGET = "room_upgrade"
    SEGMENTATION_TYPE = "hotel_customer_type"
    ...
    print(f"{SEGMENT_VALUE_1} - {SEGMENT_VALUE_2} room upgrade features saved to {feature_path}")
...
def generate_features_for_segments():
    ...
    segments = {
        # Count: 59404
        "segment_1": {
            "model_name": "city_hotel_transient",
            "segment_value_1": "City Hotel",
            "segment_value_2": "Transient"
        },
        # Count: 17333
        "segment_2": {
            "model_name": "city_hotel_transient_party",
            "segment_value_1": "City Hotel",
        ...
        # Count: 30209
        "segment_4": {
            "model_name": "resort_hotel_transient",
            "segment_value_1": "Resort Hotel",
            "segment_value_2": "Transient"
        },
        # Count: 7790
        "segment_5": {
            "model_name": "resort_hotel_transient_party",
            "segment_value_1": "Resort Hotel",
            "segment_value_2": "Transient-Party"
        },
        # Count: 2060
