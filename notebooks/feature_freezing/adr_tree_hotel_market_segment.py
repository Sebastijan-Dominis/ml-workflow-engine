...
def save_segment(segment):
    ...
    USELESS_COLUMNS = ['is_canceled', 'arrival_date_year', 'arrival_date_week_number',
       ...
       'reservation_status', 'reservation_status_date', SEGMENT_COLUMN_1, SEGMENT_COLUMN_2]
    ...
    print(f"{SEGMENT_VALUE_1} - {SEGMENT_VALUE_2} adr_tree features saved to {feature_path}")
