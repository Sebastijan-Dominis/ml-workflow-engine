...
from ml.data.utils.extraction.get_data_suffix_and_format import get_data_suffix_and_format
...
def main() -> int:
    ...
    df: pd.DataFrame
    data_path: Path
    metadata: ProcessedDatasetMetadata
    ...
    setup_logging(data_dir / "build_processed_dataset.log", level=log_level)
