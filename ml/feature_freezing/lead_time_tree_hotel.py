...
def save_segment(segment):
    ...
    USELESS_COLUMNS = ['is_canceled', 'lead_time', 'is_repeated_guest', 'reservation_status', SEGMENT_COLUMN]
    ...
    print(f"{SEGMENT_VALUE} lead-time tree-based features saved to {feature_path}")
...
def generate_features_for_segments():
    ...
    segments = {
        # Count: 79330
        "segment_1": {
            "model_name": "city_hotel",
            "segment_value": "City Hotel",
        },
        # Count: 40059
        "segment_2": {
            "model_name": "resort_hotel",
