...
feature_path = Path(f"data/features/{MODEL_NAME}/{SEGMENTATION_TYPE}/{VERSION_NAME}/")
...
print(f"Global repeated guest features saved to {feature_path}")
