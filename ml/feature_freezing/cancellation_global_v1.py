...
USELESS_COLUMNS = ["reserved_room_type"]
...
feature_path = Path(f"data/features/{TASK_NAME}/{SEGMENTATION_TYPE}/{VERSION_NAME}/")
...
print(f"Global cancellation features saved to {feature_path}")